...
class Aione_Pwa_Admin {
    ...
    function aione_pwa_add_menu_links() {           
        ...
        add_submenu_page( 'aione-dashboard', __( 'Aione Progressive Web Apps', 'aione-pwa' ),  __( 'Aione PWA', 'aione-pwa' ), 'manage_options', 'aione-pwa',array($this,'aione_pwa_admin_interface_render'),60 );
